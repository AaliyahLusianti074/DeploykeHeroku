...
def f_074_predict_compare():
    ...
    model_dict = {'Mobilenet_js' :   ['static/model/model/js/Model1.json','static/model/model/js/Model1.h5'],
                  'Maxpooling'   :   'static/model/model/Model4.h5' ,
                  'Averagepooling'   :   'static/model/model/Model5.h5' ,
                  'GlobalMaxpooling'   :   'static/model/model/Model6.h5' ,
                  }
